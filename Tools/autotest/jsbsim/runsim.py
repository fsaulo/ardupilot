...
parser.add_option("--home",    type='string', help="home lat,lng,alt,hdg (required)", default="-35.363261,149.165230,584,353")
...
# start child
cmd = "/usr/local/bin/JSBSim --realtime --nice --logdirectivefile=jsbsim/fgout.xml --script=%s" % opts.script
if opts.options:
    cmd += ' %s' % opts.options

jsb = pexpect.spawn(cmd, logfile=sys.stdout.buffer, timeout=10)
